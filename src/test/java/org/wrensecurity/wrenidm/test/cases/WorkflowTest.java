...
public class WorkflowTest extends BaseWrenidmTest {
    ...
    public void testUserRole() throws Exception {
        ...
        HttpRequest getTaskReq = HttpRequest.newBuilder()
                .uri(URI.create(WRENIDM_BASE_URL + "/openidm/workflow/taskinstance?_queryId=filtered-query&processInstanceId=" + workflowId + "&taskDefinitionKey=approval"))
                .header("Authorization", ADMIN_AUTHORIZATION_HEADER_VALUE)
                .build();
        ...
        assertEquals("complete", approveBody.get("Task action performed").asString());
        ...
        HttpRequest getHistoryReq = HttpRequest.newBuilder()
                ...
                .header("Authorization", ADMIN_AUTHORIZATION_HEADER_VALUE)
                .build();
        HttpResponse<String> getHistoryResp = httpClient.send(getHistoryReq, HttpResponse.BodyHandlers.ofString());
        assertEquals(200, getHistoryResp.statusCode());
        JsonNode historyBody = mapper.readTree(getHistoryResp.body());
        assertEquals(workflowId, historyBody.get("_id").asString());
        assertEquals("approve", historyBody.get("processVariables").get("decision").asString());
    ...
    public void testOnboarding() throws Exception {
        ...
        assertEquals("claim", claimBody.get("Task action performed").asString());
    ...
    public void testWorkflow() throws Exception {
        ...
        String onboardingDefId = onboardingDefBody.get("result").get(0).get("_id").asString();
        ...
        HttpRequest readDefFieldsReq = HttpRequest.newBuilder()
                .uri(URI.create(WRENIDM_BASE_URL + "/openidm/workflow/processdefinition/" + onboardingDefId + "?_fields=formProperties,formGenerationTemplate,diagram"))
                .header("Authorization", ADMIN_AUTHORIZATION_HEADER_VALUE)
                .build();
        ...
        HttpRequest createWorkflowReq = HttpRequest.newBuilder()
                ...
                .header("Authorization", ADMIN_AUTHORIZATION_HEADER_VALUE)
                .header("Content-Type", "application/json")
                .POST(HttpRequest.BodyPublishers.ofString(ONBOARDING_WORKFLOW_DATA.replace("\"userName\": \"onboarding\"", "\"userName\": \"onboarding-3\"")))
                .build();
        HttpResponse<String> createWorkflowResp = httpClient.send(createWorkflowReq, HttpResponse.BodyHandlers.ofString());
        assertEquals(201, createWorkflowResp.statusCode());
        JsonNode workflowBody = mapper.readTree(createWorkflowResp.body());
        ...
        HttpRequest queryInstanceReq = HttpRequest.newBuilder()
                .uri(URI.create(WRENIDM_BASE_URL + "/openidm/workflow/processinstance?_queryId=filtered-query&processInstanceId=" + workflowId))
                .header("Authorization", ADMIN_AUTHORIZATION_HEADER_VALUE)
                .build();
        ...
        assertEquals(workflowId, instanceQueryBody.get("result").get(0).get("_id").asString());

        // Read process instance details including variables and tasks
        HttpRequest readInstanceReq = HttpRequest.newBuilder()
                .uri(URI.create(WRENIDM_BASE_URL + "/openidm/workflow/processinstance/" + workflowId))
                .header("Authorization", ADMIN_AUTHORIZATION_HEADER_VALUE)
                .build();
        ...
        assertEquals(workflowId, instanceBody.get("_id").asString());
        ...
        assertEquals(workflowId, deletedHistoryBody.get("_id").asString());
        ...
        HttpRequest createWorkflow2Req = HttpRequest.newBuilder()
                .uri(URI.create(WRENIDM_BASE_URL + "/openidm/workflow/processinstance?_action=create"))
                .header("Authorization", ADMIN_AUTHORIZATION_HEADER_VALUE)
                .header("Content-Type", "application/json")
                .POST(HttpRequest.BodyPublishers.ofString(ONBOARDING_WORKFLOW_DATA.replace("\"userName\": \"onboarding\"", "\"userName\": \"onboarding-4\"")))
                .build();
        HttpResponse<String> createWorkflow2Resp = httpClient.send(createWorkflow2Req, HttpResponse.BodyHandlers.ofString());
        assertEquals(201, createWorkflow2Resp.statusCode());
        String workflowId2 = mapper.readTree(createWorkflow2Resp.body()).get("_id").asString();

        // Query for approval task associated with the workflow
        HttpRequest queryTaskReq = HttpRequest.newBuilder()
                .uri(URI.create(WRENIDM_BASE_URL + "/openidm/workflow/taskinstance?_queryId=filtered-query&processInstanceId=" + workflowId2 + "&taskDefinitionKey=approval"))
                .header("Authorization", ADMIN_AUTHORIZATION_HEADER_VALUE)
                .build();
        ...
        assertEquals(workflowId2, taskQueryBody.get("result").get(0).get("processInstanceId").asString());
        String taskId = taskQueryBody.get("result").get(0).get("_id").asString();

        // Read task details including assignee, candidates, and variables
        HttpRequest readTaskReq = HttpRequest.newBuilder()
                .uri(URI.create(WRENIDM_BASE_URL + "/openidm/workflow/taskinstance/" + taskId))
                .header("Authorization", ADMIN_AUTHORIZATION_HEADER_VALUE)
                .build();
        ...
        assertEquals(taskId, taskReadBody.get("_id").asString());
        ...
        HttpResponse<String> claimTaskResp = httpClient.send(claimTaskReq, HttpResponse.BodyHandlers.ofString());
        assertEquals(200, claimTaskResp.statusCode());
        assertEquals("claim", mapper.readTree(claimTaskResp.body()).get("Task action performed").asString());
        ...
        assertEquals("complete", mapper.readTree(completeTaskResp.body()).get("Task action performed").asString());

        // Verify task appears in history with completion timestamp
        HttpRequest queryTaskHistoryReq = HttpRequest.newBuilder()
                .uri(URI.create(WRENIDM_BASE_URL + "/openidm/workflow/taskinstance/history?_queryId=filtered-query&processInstanceId=" + workflowId2 + "&taskDefinitionKey=approval"))
                .header("Authorization", ADMIN_AUTHORIZATION_HEADER_VALUE)
                .build();
        ...
        // Verify workflow completed with rejection decision in history
        HttpRequest getHistory2Req = HttpRequest.newBuilder()
                .uri(URI.create(WRENIDM_BASE_URL + "/openidm/workflow/processinstance/history/" + workflowId2))
                .header("Authorization", ADMIN_AUTHORIZATION_HEADER_VALUE)
                .build();
        HttpResponse<String> getHistory2Resp = httpClient.send(getHistory2Req, HttpResponse.BodyHandlers.ofString());
        assertEquals(200, getHistory2Resp.statusCode());
        JsonNode history2Body = mapper.readTree(getHistory2Resp.body());
        assertEquals("reject", history2Body.get("processVariables").get("decision").asString());
        assertEquals("reject", history2Body.get("tasks").get(0).get("taskLocalVariables").get("result").asString());
    }
